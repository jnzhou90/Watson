...
//import com.ibm.personafusion.infogen.ResumeInfoGenerator;
...
//	
//					Person newPerson = new Person(name, traitList, imgURL, ri, com.ibm.findyourlove.model.Role.DEV, new ArrayList<String>());
//					
//					/*
...
//					ResumeInfo ri = new ResumeInfo(techSkills, prevInfo);
//										
//					Person newPerson = new Person(name, traitList, imgURL, ri, com.ibm.findyourlove.model.Role.Manager, new ArrayList<String>());
//					
//					newPerson.qaResponses = qaResponses;
//					
//					newPerson.keyWords = newPerson.getKeyWords(10);
